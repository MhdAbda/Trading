...
export default function StochasticChart({ data, syncId, timeRange }) {
          ...
          <ResponsiveContainer width={isAllTime ? effectiveChartWidth : "100%"} height="100%">
            <LineChart data={data} syncId={syncId} margin={{ top: 5, right: 20, left: 10, bottom: 5 }}>
              ...
              <ReferenceLine
                ...
                stroke="#f44336"
                strokeDasharray="5 5"
                label={{ value: '80', fill: '#f44336', fontSize: 10, position: 'right' }}
              />
              {/* Oversold line */}
              <ReferenceLine
                y={20}
                stroke="#4caf50"
                strokeDasharray="5 5"
                label={{ value: '20', fill: '#4caf50', fontSize: 10, position: 'right' }}
              />
              {/* %K Line */}
              <Line
                type="monotone"
